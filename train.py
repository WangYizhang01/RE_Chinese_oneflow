...
from src.tools import preprocess , CustomDataset, collate_fn ,train, validate
from src.utils import manual_seed, load_pkl
import wandb
...
def main(cfg):
    ...
    wandb.init(project="RE_Chinese_oneflow", name=cfg.model_name)
