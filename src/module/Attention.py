...
class DotAttention(nn.Module):
    ...
    def forward(self, Q, K, V, mask_out=None, head_mask=None):
        ...
        scale = float(H)**0.5
        attention_weight = oneflow.matmul(Q, K.transpose(-1, -2)) / scale
        ...
        if mask_out is not None:
            ...
            attention_weight = attention_weight.masked_fill(mask_out, -1e8)
        ...
        attention_out = oneflow.matmul(attention_weight, V)
